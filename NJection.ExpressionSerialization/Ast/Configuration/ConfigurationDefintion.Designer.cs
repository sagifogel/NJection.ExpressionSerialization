...
namespace NJection.ExpressionSerialization.Ast.Configuration {
    ...
    public partial class models {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out models obj, out System.Exception exception) {
            exception = null;
            obj = default(models);
            try {
    ...
    public partial class expression {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out expression obj, out System.Exception exception) {
            exception = null;
            obj = default(expression);
            try {
                obj = LoadFromFile(fileName, encoding);
    ...
    public partial class njection_configuration {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out njection_configuration obj, out System.Exception exception) {
            exception = null;
            obj = default(njection_configuration);
            try {
                obj = LoadFromFile(fileName, encoding);
    ...
    public partial class LambdaExpressionConfiguration : ExpressionConfiguration {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out LambdaExpressionConfiguration obj, out System.Exception exception) {
            exception = null;
            obj = default(LambdaExpressionConfiguration);
            try {
                obj = LoadFromFile(fileName, encoding);
    ...
    public abstract partial class ExpressionConfiguration {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ExpressionConfiguration obj, out System.Exception exception) {
            exception = null;
            obj = default(ExpressionConfiguration);
            try {
                obj = LoadFromFile(fileName, encoding);
    ...
    public partial class NewExpressionConfiguration : ExpressionConfiguration {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out NewExpressionConfiguration obj, out System.Exception exception) {
            exception = null;
            obj = default(NewExpressionConfiguration);
            try {
                obj = LoadFromFile(fileName, encoding);
    ...
    public partial class ParameterExpressionConfiguration : ExpressionConfiguration {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ParameterExpressionConfiguration obj, out System.Exception exception) {
            exception = null;
            obj = default(ParameterExpressionConfiguration);
            try {
                obj = LoadFromFile(fileName, encoding);
    ...
    public partial class ConstantExpressionConfiguration : ExpressionConfiguration {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConstantExpressionConfiguration obj, out System.Exception exception) {
            exception = null;
            obj = default(ConstantExpressionConfiguration);
            try {
                obj = LoadFromFile(fileName, encoding);
